  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100">
      ...
      <form onSubmit={handleSignIn} className='flex flex-col items-stretch w-full max-w-sm mt-10 gap-4'>
        ...
        <label htmlFor="email" className='flex flex-col gap-3'>
          ...
          <TextInput.Root>
            ...
            <TextInput.Input type='email' placeholder='e.g., jane@email.com' />
          </TextInput.Root>
        </label>
      ...
      <footer className='flex flex-col items-center gap-4 mt-8'>
        ...
        <Text asChild size='sm'>
          <a href="" className='text-gray-400 underline hover:text-gray-200'>No account yet? Sign up!</a>
        </Text>
      </footer>
